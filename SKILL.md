...
> **版本**: v3.1.0 企业级 | **更新**: 2026-07-12
> **模块数**: 16 | **函数数**: 89 | **规范数**: 120+
> 编辑任意 `modules/*.md` 后运行 `python assemble.py` 重新生成 SKILL.md

本技能为企业级大型工程综合工具，覆盖工程全生命周期十大核心能力：
...
| 10 | **图纸智能分析与自动算量** | **15-drawing-to-quantity.md** | **14** |
...
<!-- 自动生成于 2026-07-13 00:19:08 | 模块数: 16 | 文件大小: 240,724 bytes -->
